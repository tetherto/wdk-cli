...
export async function getAddress(network: NetworkName, index: number, wallet: string = configService.getDefaultWallet()): Promise<string> {
...
export async function getBalance(
  ...
  index: number,
  token?: string,
  wallet: string = configService.getDefaultWallet(),
