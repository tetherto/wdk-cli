...
import { previewSwap } from '../actions/swap.js'
import { printSwapPreview } from '../ui/swap.js'
    ...
    try {
      ...
      if (!options.dryRun) {
        throw new WdkCliError(
          'Swap execution is not available yet.',
          ErrorCode.INVALID_ARGUMENT,
          'Run with --dry-run to see the best-route quote.'
        )
      }
