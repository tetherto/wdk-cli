...
describe('encryption', () => {
  it('encrypts deterministically with pinned salt+iv', () => {
    ...
    assert.equal(decrypt(payload, 'testpassword123'), PHRASE)
  })
  ...
  it('rejects wrong password', () => {
    ...
    assert.throws(() => decrypt(payload, 'wrongpassword'))
  })
  ...
  it('rejects unsupported version', () => {
    ...
    assert.throws(() => decrypt(badPayload, 'pass'), /Unsupported keyring version/)
  })
})
